...
export const QUIRKS: Record<string, QuirkDef> = {
  ...
  "hallucinated": {
    ...
    tiers: tiers("hallucinated",
      ...
      ["Library Hopeful", "100 hallucinations. The registry queue is now alphabetized by your suggestions."],
  ...
  "node-modules-rm": {
    id: "node-modules-rm", label: "nuked node_modules", frame: "rm -rf node_modules && bun install",
    tiers: tiers("node-modules-rm",
      ["The Classic", "First. Tale as old as node_modules."],
