...
const Privacy = () => <>
  <h2>Information we collect</h2><p>Renown processes account details, linked provider identities, public developer activity, gameplay and marketplace actions, device and security signals, and support communications. Private repository names, paths, commit messages, diffs, and per-repository metrics remain on the developer's device and are not intentionally uploaded to Renown. Stripe processes card, billing, identity-verification, and payout information; Renown does not receive or store complete card numbers.</p>
